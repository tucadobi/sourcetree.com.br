...
if (typeof window.jQuery == "undefined")
{
    ...
    jQuery = function(a, c)
    {
        ...
        this.get( a.constructor == Array || a.length && !a.nodeType && a[0] != undefined && a[0].nodeType ?
            ...
            /**
             * Encontre os elementos correspondentes e salve-os para mais tarde.
             */
            jQuery.find(a, c)
        );
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        {
            /**
             * Observe quando um vetor (de elementos) é passado.
             */
    ...
    jQuery.extend({
        ...
        clean: function(a)
        {
            ...
            for (var i = 0; i < a.length; i++)
            {
                ...
                {
                    /**
                     * Apare os espaços em branco, caso contrário,
        ...
        attr: function(elem, name, value)
        {
            ...
            if (name == "opacity" && jQuery.browser.msie && value != undefined)
            {
                 ...
                 * layout. Prefiro verificar element.hasLayout primeiro,
                 * mas não tenho acesso ao elemento aqui.
                 */
                elem['zoom'] = 1;
        ...
        filter: function(t, r, not)
        {
            ...
            while (t && /^[a-z[({<*:.#]/i.test(t))
            {
                ...
                {
                    /**
                     * Procure e substitua sequências semelhantes a strings e,
                     * finalmente, crie um regexp a partir delas.
                     */
        ...
        merge: function(first, second)
        {
            ...
            /**
             * Agora verifique se há duplicatas entre (a e b) e
             * adicione apenas os itens exclusivos.
             */
        ...
        event: {
            ...
            add: function(element, type, handler)
            {
                ...
                if (!handlers)
                {
                    ...
                    /**
                     * Lembre-se de um manipulador existente, se
                     * já estiver lá.
                     */
                    if (element["on" + type])
                    {
    ...
    jQuery.fn.extend({
        ...
        {
            /**
             * Se duas funções forem passadas, alternaremos com
             * um clique.
             */
    ...
    jQuery.extend({
        ...
        ready: function()
        {
            ...
            if (!jQuery.isReady)
            {
                ...
                /**
                 * Remova o ouvinte de eventos para evitar
    ...
    new function()
    {
        ...
        } else if (jQuery.browser.safari)
        {
            ...
            {
                /**
                 * Carregados e concluídos são estados válidos.
                 */
    ...
    jQuery.extend({
        ...
        /**
         * Originalmente, escrevi fx() como um clone de moo.fx
        ...
        fx: function(elem, options, prop)
        {
            ...
            z.a = function()
            {
                ...
                {
                    /**
                     * Questão: falhas no IE em compatibilidade ?
                     */
            ...
            z.show = function(p)
            {
                ...
                /**
                 * Questão: incompatibilidade no IE ?
                 */
                if (prop != "opacity")
                {
                    y[prop] = "1px";
            ...
            /**
             * Lembre-se do overflow do elemento.
             */
            if (!z.el.oldOverlay)
            {
    ...
    jQuery.extend({
        ...
        get: function(url, data, callback, type, ifModified)
        {
            ...
            /**
             * Acrescentar '?' + data ou '&' + data, caso já existam
             * parâmetros.
             */
            if (data)
            {
                url += ((url.indexOf("?") > -1) ? "&" : "?") + jQuery.param(data);
            }
        ...
        {
            /**
             * Se apenas um único argumento foi passado, suponha
             * que seja um objeto de pares chave/valor.
             */
            if (!url)
            {
                ret = type.complete;
            ...
            /**
             * Defina o cabeçalho If-Modified-Since, se estiver
             * no modo ifModified.
             */
            if (ifModified)
            {
            ...
            var onreadystatechange = function(istimeout)
            {
                ...
                if (xml && (xml.readyState == 4 || istimeout == "timeout"))
                {
                    ...
                    if (status != "error")
                    {
                        ...
                        /**
                         * Exceção de swallow lançada pelo FF se o título
         ...
         * XML analisado se o título do tipo de conteúdo for
         * "xml" e o tipo for "xml" ou omitido, caso contrário,
         * retorne texto simples. (String) data - O tipo de
         * dados que você espera retornar (por exemplo, "xml",
         * "html", "script").
         */
        ...
        param: function(a)
        {
            ...
            /**
             * Se um array foi passado, suponha que seja um array de
             * elementos de formulário.
             */
            if (a.constructor == Array || a.jquery)
            {
                ...
                /**
                 * Caso contrário, suponha que seja um objeto
