...
if(typeof window.jQuery == "undefined")
{
    ...
    {
        /**
         * Fique atento ao caso em que nulo ou indefinido é
         * passado acidentalmente
         */
        ...
        /**
         * Se nenhum objeto de propriedade foi fornecido, estamos
         * estendendo o jQuery.
         */
        if (!prop)
        {
    ...
    jQuery.extend({
        ...
        clean: function(a)
        {
            ...
            for (var i = 0; i < a.length; i++)
            {
                ...
                if (arg.constructor == String)
                {
                    ...
                    /**
                     * É necessário percorrer os childNodes aqui para
                     * evitar uma falha do Safari com nós de texto e
                     * caracteres /n.
                     */
            ...
            while (t.length > 0 && last != t)
            {
                ...
                if (!foundToken)
                {
                    ...
                    } else
                    {
                        ...
                        {
                            /**
                             * Ummm, deveria fazer isso funcionar em todos os
                             * documentos XML.
                             */
        ...
        event: {
            ...
            fix: function(event)
            {
                ...
                {
                    /**
                     * Obter evento real de window.event.
                     */
                    event = window.event;

                    /**
                     * Corrigir propriedade de destino.
                     */
                ...
                } else if (jQuery.browser.safari && event.target.nodeType == 3)
                {
                    ...
                    /**
                     * Obter parentnode de textnode.
                     */
                    event.target = event.target.parentNode;
                }

                /**
                 * Melhorar preventDefault e stopPropagation.
                 */
        ...
        for (var i = 0; i < e.length; i++)
            ...
            jQuery.fn["one" + o] = function(f)
            {
                ...
                var handler = function()
                {
                    ...
                    /**
                     * Aplique o manipulador original com os mesmos argumentos.
                     */
    ...
    jQuery.extend({
        ...
        fx: function(elem, options, prop)
        {
            ...
            z.a = function()
            {
                ...
                {
                    /**
                     * Questão: incompatibilidades do IE ?
                     */
        ...
        evalScripts: function()
        {
            return this.find('script').each(function()
            {
                if (this.src)
                {
                     ...
                     * retorno de chamada for omitido.
                     */
    ...
    jQuery.extend({
        ...
        get: function(url, data, callback, type, ifModified)
        {
            ...
            /**
             * Acrescentar '?' + dados ou '&' + dados, caso já
             * existam parâmetros.
             */
            if (data)
            {
        ...
        /**
         * Serialize um vetor de elementos de formulário
         * ou um conjunto de chaves/valores em uma string
         * de consulta.
         */
        param: function(a)
        {
            ...
            /**
             * Se um array foi passado, suponha que seja
             * um array de elementos de formulário.
             */
