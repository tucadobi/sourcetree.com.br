...
if (typeof window.jQuery == "undefined")
{
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        add: function(t)
        {
            return this.pushStack(
                jQuery.merge(
                    this.get(),
                    t.constructor == String ? jQuery(t).get() : t.length != undefined && !t.nodeName ? t : [t]
                )
            );
        },
    ...
    jQuery.extend({
        ...
        /**
         * Isso pode parecer um código maluco, mas acredite em
        ...
        clean: function(a)
        {
            ...
            jQuery.each(a, function(i, arg)
            {
                ...
                if (typeof arg == "string")
                {
                    ...
                    /**
                     * Vá para html e volte, depois retire os
                     * invólucros extras.
                     */
                    ...
                    if (jQuery.browser.msie)
                    {
                        ...
                        {
                            /**
                             * String estava nu em <thead> ou <tfoot>.
                             */
                            tb = div.childNodes;
                        }
        ...
        merge: function(first, second)
        {
            ...
            /**
             * Agora verifique se há duplicatas entre as duas
             * matrizes e adicione apenas os itens exclusivos.
             */
    ...
    jQuery.extend({
        ...
        find: function(t, context)
        {
            ...
            /**
             * Continue enquanto existir uma expressão seletora
             * e enquanto não estivermos mais repetindo sobre
             * nós mesmos.
             */
            while (t && last != t)
            {
                ...
                if (t && !foundToken)
                {
                    ...
                    } else
                    {
                        ...
                        /**
                         * Reorganize os resultados para que fiquem consistentes.
                         */
                        if (m)
                        {
                            m = [0, m[2], m[3], m[1]];
                        ...
                        } else
                        {
                            ...
                            jQuery.each(ret, function()
                            {
                                ...
                                /**
                                 * Lidar com o IE7 sendo realmente incompatível
                                 * com <object>s.
                                 */
        ...
        filter: function(t, r, not)
        {
            ...
            while (t && /^[a-z[({<*:.#]/i.test(t))
            {
                ...
                {
                    /**
                     * Procure e substitua sequências semelhantes a
                     * strings e, finalmente, crie um regexp a partir delas.
                     */
                    m = re.exec(t);
                ...
                {
                    /**
                     * Trate as classes como um caso especial (isso ajudará
                     * a melhorar a velocidade, pois o regexp será compilado
                     * apenas uma vez).
                     */
    ...
    jQuery.event = {
        ...
        trigger: function(type, data, element)
        {
            ...
            } else
            {
                 ...
                 *
                 */
                var handler = element["on" + type ], val, fn = jQuery.isFunction(element[type]);
        ...
        fix: function(event)
        {
            ...
            if (jQuery.browser.safari && event.target.nodeType == 3)
            {
                 ...
                 * clone porque o destino é somente leitura.
                 */
            ...
            /**
             * Consertar preventDefault e stopPropagation.
             */
    ...
    jQuery.fn.extend({
        ...
        hover: function(f, g)
        {
            ...
            function handleHover(e)
            {
                ...
                /**
                 * Se realmente passarmos o mouse sobre um
                 * subelemento, ignore-o.
                 */
                if (p == this)
                {
                    return false;
    ...
    jQuery.extend({
                ...
                if (xml && (xml.readyState == 4 || isTimeout == "timeout"))
                {
                    ...
                    try
                    {
                        ...
                        if (status != "error")
                        {
                            ...
                            /**
                             * Exceção de engolir lançada por FF se o título
                            ...
                            /**
                             * Envia o retorno de chamada global.
                             */
                            if (s.global)
                            {
        ...
        httpData: function(r, type)
        {
            ...
            /**
             * Se o tipo for "script", avalie-o no contexto
             * global.
             */
            if (type == "script")
            {
        ...
        param: function(a)
        {
            ...
            /**
             * Devolve a serialização resultante.
             */
            return s.join("&");
        },
