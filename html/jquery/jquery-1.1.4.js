...
(function()
{
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        {
            /**
             * Os elementos para envolver o target.
             */
        ...
        clone: function(deep)
        {
            ...
            if (jQuery.browser.msie)
            {
                ...
                {
                    /**
                     * Adicione os eventos de volta ao original e seus
                     * descendentes.
                     */
            ...
            /**
             * Copie os valores do formulário.
             */
            if (deep)
            {
    ...
    jQuery.extend({
        ...
        /**
         * Isso pode parecer um código complexo, mas acredite
         * em mim quando digo que esta é a única maneira de
         * fazer isso em vários navegadores.
         */
        ...
        each: function(obj, fn, args)
        {
            if (args)
            {
                ...
                /**
                 * Um case especial e rápido para o uso mais comum de cada um.
                 */
            } else
            {
                if (obj.length == undefined)
        ...
        curCSS: function(elem, prop, force)
        {
             ...
             * de um elemento estão com falhas.
             */
            function color(a)
            {
        ...
        clean: function(a, doc)
        {
            ...
            jQuery.each(a, function(i, arg)
            {
                ...
                {
                    /**
                     * Remover os espaços em branco, caso contrário,
        ...
        attr: function(elem, name, value)
        {
             ...
             * padrão de uma opção oculta. Acessar a propriedade
             * selectedIndex do pai corrige o problema.
             */
    ...
    jQuery.event = {
        ...
        fix: function(event)
        {
             ...
             * Observação: o botão não está normalizado, portanto não o
             * utilize.
             */
    ...
    jQuery.fn.extend({
         ...
         * @deprecated.
         *
         * Este método não faz mais nada - toda a avaliação do script
         * é feita nos métodos de injeção de HTML.
         */
    ...
    jQuery.extend({
        ...
        ajax: function(s)
        {
            ...
            /**
             * Defina o título para que o script chamado saiba que é
             * um XMLHttpRequest.
             */
            ...
            {
                /**
                 * A transferência foi concluída e os dados estão disponíveis
                 * ou a solicitação expirou.
                 */
                if (!requestDone && xml && (xml.readyState == 4 || isTimeout == "timeout"))
                {
                    ...
                    if (status == "success")
                    {
                        ...
                        try
                        {
                             ...
                             * httpData independentemente do retorno de
                             * chamada).
                             */
                    ...
                    {
                        /**
                         * Título Last-Modified em cache, se estiver no modo
                         * ifModified.
                         */
                        var modRes;

                        /**
                         * Exceção de engolir lançada por FF se o título não
                         * estiver disponível.
                         */
                        try
                        {
        ...
        httpNotModified: function(xml, url)
        {
            try
            {
                ...
                /**
                 * O Firefox sempre retorna 200. verifique a data da última
                 * modificação.
                 */
        ...
        /**
         * Obtenha os dados de um XMLHttpRequest. Retorna XML analisado
         * se o título do tipo de conteúdo for "xml" e o tipo for "xml"
         * ou omitido, caso contrário, retorne texto simples. (String) data -
         * O tipo de dados que você espera retornar (por exemplo, "xml",
         * "html", "script").
         */
        ...
        param: function(a)
        {
            ...
            /**
             * Se um vetor foi passado, suponha que seja um vetor
    ...
    jQuery.extend({
        ...
        /**
         * Originalmente, escrevi fx() como um clone de moo.fx e, no
         * processo de torná-lo pequeno, o código tornou-se ilegível
         * para pessoas sãs. Voce foi avisado.
         */
