...
jQuery.extend({
    ...
    css: function(e, p)
    {
        ...
        {
            return parseFloat(
                jQuery.curCSS(e, "filter").replace(/[^0-9.]/,"")
            ) || 1;
        }
    ...
    parse: [
        /**
         * Correspondencia: [@value='test'], [@foo].
         */
        [ "\\[ *(@)S *([!*$^=]*) *Q\\]", 1 ],

        /**
         * Correspondencia: [div], [div p].
         */
        [ "(\\[)Q\\]", 0 ],

        /**
         * Correspondencia: :contains('foo').
         */
        [ "(:)S\\(Q\\)", 0 ],

        /**
         * Correspondencia: :even, :last-chlid.
         */
        [ "([:.#]*)S", 0 ]
    ],
    ...
    {
        /**
         * Descubra se estamos fazendo filtragem regular
         * ou inversa.
         */
...
new function()
{
    ...
    /**
     * Verifique todos os nomes de eventos, mas
     * certifique-se de que estejam devidamente
     * incluídos.
     */
...
jQuery.extend({
    ...
    ajax: function(type, url, data, ret, ifModified)
    {
        ...
        /**
         * Defina o título If-Modified-Since, se for
         * modo ifModified.
         */
        if (ifModified)
        {
        ...
        /**
         * Defina o título para que o script de chamada
    ...
    /**
     * Determina se um XMLHttpRequest foi bem-sucedido
     * ou não.
     */
