...
if(typeof window.jQuery == "undefined")
{
        ...
        clone: function(deep)
        {
            return this.pushStack(
                jQuery.map(this, function(a)
                {
                    ...
                    /**
                     * drop $events expando para evitar enviar eventos
                     * incorretos.
                     */
                    a.$events = null;
                ...
                if (t && !foundToken)
                {
                    ...
                    } else
                    {
                        ...
                        if (m[1] == "#" && ret[ret.length - 1].getElementById)
                        {
                            ...
                            /**
                             * Faça uma verificação rápida da existência do
                        ...
                        } else
                        {
                            ...
                            jQuery.each(ret, function()
                            {
                                ...
                                /**
                                 * Lide com o IE7 sendo realmente falho sobre
                                 * <object>s.
                                 */
        ...
        filter: function(t, r, not)
        {
            ...
            while (t && /^[a-z[({<*:.#]/i.test(t))
            {
                ...
                jQuery.each(p, function(i, re)
                {
                     ...
                     * strings e, finalmente, crie um regexp a
                     * partir delas.
                     */
                    m = re.exec(t);
    ...
    jQuery.event = {
        ...
        remove: function(element, type, handler)
        {
            if (element.$events)
            {
                ...
                /**
                 * Remova o manipulador de eventos se não existirem
                 * mais manipuladores.
                 */
    ...
    jQuery.extend({
        ...
        ajax: function(s)
        {
             ...
             * cliente modificá-las para todas as solicitações,
            ...
            /**
             * Defina o título correto, se os dados estiverem sendo enviados.
             */
            if (s.data)
            {
         ...
         * contrário, retorne texto simples. (String) data - O
         * tipo de dados que você espera retornar (por
